...
// event.preventDefault - js built in method 
  ...
  var game = {
    ...
    start: function(){
      ...
      $('#qContainer').prepend('<h2>Time Remaining: <span id="counter">120</span> Seconds</h2>');
      $('#start, .game-info').remove();
      for(var i=0; i<questionAnswers.length; i++){
        $('#qContainer').append('<h3>' + questionAnswers[i].question + '</h3>')
        for(var j=0; j < questionAnswers[i].answers.length; j++){
          $('#qContainer').append("<input class='check-with-label' type='radio' name='question-" + i + "' value='"+questionAnswers[i].answers[j]+"'>  <label class='label-for-check'>"+ questionAnswers[i].answers[j]+"  </label></br>");
        }
      }
    ...
    // checking each input if it is a correct answer or wrong answer and incrementing my game.correct and game.incorrect
      ...
      $.each($('input[name="question-0"]:checked'), function(){
          console.log(questionAnswers[0].correctAnswer);
        if($(this).val() === questionAnswers[0].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-1"]:checked'), function(){
        if($(this).val() === questionAnswers[1].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-2"]:checked'), function(){
        if($(this).val() === questionAnswers[2].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-3"]:checked'), function(){
        if($(this).val() === questionAnswers[3].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-4"]:checked'), function(){
        if($(this).val() === questionAnswers[4].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-5"]:checked'), function(){
        if($(this).val() === questionAnswers[5].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-6"]:checked'), function(){
        if($(this).val() === questionAnswers[6].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-7"]:checked'), function(){
        if($(this).val() === questionAnswers[7].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-8"]:checked'), function(){
        if($(this).val() === questionAnswers[8].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-9"]:checked'), function(){
        if($(this).val() === questionAnswers[9].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
      ...
      $.each($('input[name="question-10"]:checked'), function(){
        if($(this).val() === questionAnswers[10].correctAnswer){
          game.correct++;
        }
        else {
          game.incorrect++;
...
//  Cancel on click.
    ...
    result: function(){
      ...
      $('#subwrapper').append("<h3>Unanswered: "+(questionAnswers.length-(this.incorrect+this.correct))+"<h3>");
    },
}  
